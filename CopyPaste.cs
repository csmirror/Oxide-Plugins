			...
			foreach(var data in entities)
			{
				...
				if(entity != null)
				{
					...
					if(cupboard != null)
					{
						...
						foreach(var userID in cupboardData["authorizedPlayers"] as List<object>)
						{
						...
						//TODO Позже доделать нормально
						
						if(data.ContainsKey("auth") && player != null && !cupboard.IsAuthed(player))
						{
							cupboard.authorizedPlayers.Add(new PlayerNameID()
							{
